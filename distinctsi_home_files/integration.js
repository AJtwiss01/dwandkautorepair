    ...
    if (isdefined("BASE_CustomerKey")) {
      ...
      if (BASE_CustomerKey != '') {
        ...
        if (!isdefined("BASE_CustomImg")) {
	      ...
	      // Default image
		  var browser = new BASEBrowserDetect(); 
		
		  if ((browser.isGecko) || (browser.isIE5up && browser.isMac) ||
			  ...
			  (browser.isIcab && browser.versionMinor >= 1.9) || (browser.isWebtv) || (browser.isDreamcast) ||
			  (browser.isIE7up)) {
            ImgURL = 'https://download.beanywhere.com/corporate/integration/img/default.png';
		  } else {
            ImgURL = 'https://download.beanywhere.com/corporate/integration/img/default.gif';
		  }
	    ...
	    if (ImgURL != '') {
          document.write('<a href="https://secure.corporate.beanywhere.com/integration/integration.php?uid=' + BASE_CustomerKey + '"><img src="' + ImgURL + '" border="0" alt="' + ImgAlt + '" title="' + ImgTitle + '"></a>');
		}
